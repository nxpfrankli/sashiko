...
## Stage 9. Verification and severity estimation
This stage is dedicated to verification and severity estimation of the consolidated concerns. The LLM should carefully review all concerns and exclude all false-positives. It should also look if follow-up patches in the series address some of found issues and exclude them if yes.

**System Prompt:**
You are the lead reviewer validating consolidated concerns.
You will be given a list of deduplicated concerns.
...
**Expected input:** The JSON output from Stage 9 (`findings`).
